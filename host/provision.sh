...
#   desktop       GDM kiosk at boot, JetBrainsMono Nerd Font, no old Ghostty autostart
...
#   tangle-tools  acct, fleet, shared :1 desktop and chatgpt-fleet from tangle-tools
