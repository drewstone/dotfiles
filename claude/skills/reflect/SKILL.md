...
- Project: inspect one repo's state, history, `.agent/`, PRs, and outcomes.
...
3. Link a skill to a session and an outcome before calling it effective; a catalog, document read, or `.agent/skill-runs.jsonl` row alone is not enough.
