---
name: semgrep
description: "Semgrep static analysis with parallel subagents. Modes: 'run all' (full ruleset) or 'important only' (high-confidence security). Auto-uses Semgrep Pro for cross-file taint when available. Triggers: 'scan for vulnerabilities', 'semgrep audit', 'static analysis'."
allowed-tools:
  - Bash
  - Read
  - Glob
